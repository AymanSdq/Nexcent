...
const Marketing = () => {
    return (
        <section className="w-full max-md:hidden pt-10 pb-30 md:px-[144px] px-6 flex flex-col gap-4 justify-center items-center">
                ...
                <div className="w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 items-center gap-6 pt-6">
                    {/* Cards */}
                    ...
                    <div className="col-span-1 max-md:pt-42 h-[250px] relative rounded-md">
